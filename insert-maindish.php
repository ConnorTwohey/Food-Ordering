<?php
  ...
  function insert_maindish($name, $descrip, $price, $image, $stock, $calories, $fats, $size, $ishot) {
    try{
	...
	try{
		...
		$stmt = $pdo->prepare("INSERT INTO `MainDish` (`Pid`, `Size`, `IsHot`) VALUES (:pid, :size, :ishot);");
