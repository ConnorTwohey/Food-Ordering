<?php
  ...
  function insert_maindish($pname, $descrip, $price, $fpath, $stock, $cal, $fats, $size, $isHot) {
    try{
    ...
    try {
      ...
      $stmt = $pdo->prepare("INSERT INTO `MainDish` (`Pid`, `Size`, `IsHot`) VALUES (:pid, :size, :hot);");
      $stmt->bindParam(':pid',$pid);
      $stmt->bindParam(':size',$size);
      $stmt->bindParam(':hot',$isHot);
