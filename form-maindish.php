...
<?php
  ...
  $pnameErr = $descripErr = $priceErr = $imageErr = $stockErr = $calErr = $fatsErr = $sizeErr = "";
		$pname = $descrip = $image = $size = $isHot = "";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST"){
            ...
            echo "$pname, $descrip, $price, $image, $stock, $cal, $fats, $size, $isHot";
...
Calories: <input type="number" name="Calories" value="<?php echo $phone;?>" min="0">
  ...
  Size: <input type="text" name="Size" value="<?php echo $size;?>" maxlength="1">
    ...
    Is Hot: <input type="text" name="isHot" value="<?php echo $isHot;?>" maxlength="1">

    <input type="submit" name="submit" value="Submit">
  </form>
  <p>Click the "Submit" button to input Main Dish data.</p>
